...
PRESET_STRATEGIES = {
    ...
    "趋势加速": {
        "description": "均线多头 + MACD动能为正 + DI看多，确认趋势加速阶段，适合顺势加仓",
        "layer1": {
            "exclude_st": True,
            "exclude_suspended": True,
            "exclude_bse": True,
        ...
        "layer4": {
            ...
            "min_bias": -8,
            "wr_overbought": 999,
            "boll_upper_limit": 0.9,
        },
    },
    "低位蓄力": {
        "description": "BOLL下半区 + MACD翻正 + RSI偏低未超卖，底部企稳蓄势待发",
        "layer1": {
            "exclude_st": True,
            "exclude_suspended": True,
            "exclude_bse": True,
        ...
        "layer4": {
            ...
            "min_bias": -12,
            "wr_overbought": 999,
            "boll_upper_limit": 0.5,
        },
    },
    "强势整理": {
        "description": "均线多头 + 均线粘合收窄 + 量能适中，强势股横盘整理即将二次启动",
        "layer1": {
            "exclude_st": True,
            "exclude_suspended": True,
            "exclude_bse": True,
        ...
        "layer4": {
            ...
            "min_bias": -6,
            "wr_overbought": 999,
            "boll_upper_limit": 0.8,
        },
    },
    "动能恢复": {
        "description": "DI看多 + MACD由负转正 + RSI温和回升，下跌后动能恢复的早期信号",
        "layer1": {
            "exclude_st": True,
            "exclude_suspended": True,
            "exclude_bse": True,
        ...
        "layer4": {
            "max_drawdown_limit": 18,
            "max_consecutive_down": -5,
            "max_bias": 5,
            "min_bias": -10,
            "wr_overbought": 999,
            "boll_upper_limit": 0.7,
        },
    },
    "量价齐升": {
        "description": "温和放量 + MACD为正 + 乖离率适中 + BOLL中轨附近，量价配合健康上行",
        "layer1": {
            "exclude_st": True,
            "exclude_suspended": True,
            "exclude_bse": True,
